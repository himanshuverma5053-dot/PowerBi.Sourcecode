...
export function upsertProduct(req: Request, res: Response) {
  ...
  const productToSave: TyreProduct = {
    ...
    image: productData.image || '/src/assets/images/apollo_endutrax_ma_exact_1786967778525.jpg',
    images: productData.images || [productData.image || '/src/assets/images/apollo_endutrax_ma_exact_1786967778525.jpg'],
