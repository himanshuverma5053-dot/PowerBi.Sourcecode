...
export const Footer: React.FC<FooterProps> = ({ setActiveTab }) => {
  return (
    <footer className="bg-gradient-to-b from-slate-950 via-purple-950 to-slate-950 text-slate-300 pt-16 pb-12 border-t border-purple-900/40 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-600/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-indigo-600/10 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-purple-900/50">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <div className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-purple-900/40 border border-purple-800/50 text-xs text-purple-200">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <button onClick={() => setActiveTab('catalogue')} className="hover:text-purple-300 transition-colors">
                  Tyre Store Catalogue
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('quick-order')} className="hover:text-purple-300 transition-colors">
                  Quick Order Section
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('quick-payments')} className="hover:text-purple-300 transition-colors">
                  Quick Payments Portal
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('account')} className="hover:text-purple-300 transition-colors">
                  My Account & Profile
                </button>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li className="hover:text-purple-300 cursor-pointer" onClick={() => setActiveTab('catalogue')}>Heavy Commercial Truck Tyres</li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 text-sm text-slate-400">
              ...
              <div className="flex items-center space-x-2.5 text-xs text-purple-300 pt-1">
