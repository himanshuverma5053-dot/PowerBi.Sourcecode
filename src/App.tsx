    ...
    <div className="min-h-screen bg-[#F7F7F7] text-slate-900 font-sans flex flex-col selection:bg-slate-900 selection:text-white overflow-x-hidden w-full max-w-full">
      ...
      {interfaceMode === 'admin' ? (
        ...
        {activeTab === 'catalogue' && (() => {
          ...
          return (
            <div id="products-container" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-1">
                      ...
                      {isProductsLoading && (
                        <span className="inline-flex items-center gap-1.5 text-[11px] text-[#0972D3] font-semibold bg-sky-50 px-2.5 py-0.5 rounded-full">
                          <RefreshCw className="w-3 h-3 animate-spin" />
                          <span>Fetching from DynamoDB & S3...</span>
                        </span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="w-full md:w-auto flex items-center gap-2.5">
                    ...
                    >
                      <RefreshCw className={`w-3.5 h-3.5 ${isProductsLoading ? 'animate-spin text-[#0972D3]' : ''}`} />
